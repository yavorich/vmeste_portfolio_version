...
from config.settings import TINKOFF_TERMINAL_KEY, TINKOFF_PASSWORD


class TinkoffPaymentApi(BaseTinkoffPaymentApi):
    _terminal_key = TINKOFF_TERMINAL_KEY
    encrypter = TinkoffTokenEncrypter(TINKOFF_PASSWORD)
